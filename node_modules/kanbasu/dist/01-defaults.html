...
<head>
	...
	<title>Defaults &middot; Kanbasu</title>
...
<h1 data-f-toggle="labels">Defaults</h1>


<div class="f-item-group" id="forms">

	<div class="f-item-heading-group" data-f-toggle="labels">
		<h2 class="f-item-heading">Forms</h2>
	</div>

			<div class="f-item-group" id="forms.01.input">
				<div class="f-item-heading-group" data-f-toggle="labels">
	<h3 class="f-item-heading">Input</h3>
</div>
...
<div class="f-item-controls">
	<span class="f-control" data-f-toggle-control="code" title="Toggle Code">
		...
		Toggle code
			...
			<div class="f-item-group" id="forms.02.select">
				<div class="f-item-heading-group" data-f-toggle="labels">
	<h3 class="f-item-heading">Select</h3>
</div>
<div class="f-item-notes" data-f-toggle="notes">


		<p>Notice: some browsers don’t care about <code>border-radius</code> property applied to select.</p>
...
<div class="f-item-controls">
	<span class="f-control" data-f-toggle-control="code" title="Toggle Code">
		...
		Toggle code
			...
			<div class="f-item-group" id="forms.03.textarea">
				<div class="f-item-heading-group" data-f-toggle="labels">
	<h3 class="f-item-heading">Textarea</h3>
</div>
<div class="f-item-notes" data-f-toggle="notes">


		<p>Use the <code>rows</code> attribute to make it higher.</p>
...
<div class="f-item-code f-item-hidden" data-f-toggle="code">
	<pre><code class="language-markup">&lt;textarea&gt;&lt;/textarea&gt;</code></pre>
</div>
<div class="f-item-controls">
	<span class="f-control" data-f-toggle-control="code" title="Toggle Code">
		<span class="f-icon">
		...
		Toggle code
			...
			<div class="f-item-group" id="forms.04.checkbox-and-radio">
				<div class="f-item-heading-group" data-f-toggle="labels">
	<h3 class="f-item-heading">Checkbox And Radio</h3>
</div>
<div class="f-item-notes" data-f-toggle="notes">
...
<div class="f-item-controls">
	<span class="f-control" data-f-toggle-control="code" title="Toggle Code">
		...
		Toggle code
			...
			<div class="f-item-group" id="forms.05.checkbox-and-radio-inline">
				<div class="f-item-heading-group" data-f-toggle="labels">
	<h3 class="f-item-heading">Checkbox And Radio Inline</h3>
</div>
<div class="f-item-notes" data-f-toggle="notes">
...
<div class="f-item-controls">
	<span class="f-control" data-f-toggle-control="code" title="Toggle Code">
		...
		Toggle code
			...
			<div class="f-item-group" id="forms.06.input-and-select-size">
				<div class="f-item-heading-group" data-f-toggle="labels">
	<h3 class="f-item-heading">Input And Select Size</h3>
</div>
<div class="f-item-notes" data-f-toggle="notes">
		<div class="text-muted"><p>Select since 1.2.0</p>
</div>
...
<div class="f-item-group" id="headings">

	<div class="f-item-heading-group" data-f-toggle="labels">
		<h2 class="f-item-heading">Headings</h2>
	</div>

		<div class="f-item-notes" data-f-toggle="notes">


		<p>You can also apply these styles to other elements with <code>.h1</code>, <code>.h2</code>, …</p>
...
<div class="f-item-code f-item-hidden" data-f-toggle="code">
	<pre><code class="language-markup">&lt;h1&gt;Lorem ipsum dolor sit amet&lt;/h1&gt;
&lt;h2&gt;Lorem ipsum dolor sit amet&lt;/h2&gt;
&lt;h3&gt;Lorem ipsum dolor sit amet&lt;/h3&gt;
&lt;h4&gt;Lorem ipsum dolor sit amet&lt;/h4&gt;
&lt;h5&gt;Lorem ipsum dolor sit amet&lt;/h5&gt;
&lt;h6&gt;Lorem ipsum dolor sit amet&lt;/h6&gt;</code></pre>
</div>
<div class="f-item-controls">
	<span class="f-control" data-f-toggle-control="code" title="Toggle Code">
		<span class="f-icon">
...
<div class="f-item-group" id="lists">
	...
	<div class="f-item-heading-group" data-f-toggle="labels">
		<h2 class="f-item-heading">Lists</h2>
			...
			<div class="f-item-group" id="lists.descriptions">
				<div class="f-item-heading-group" data-f-toggle="labels">
	<h3 class="f-item-heading">Descriptions</h3>
</div>
<div class="f-item-notes" data-f-toggle="notes">
...
<div class="f-item-code f-item-hidden" data-f-toggle="code">
	<pre><code class="language-markup">&lt;p&gt;Quisque eget odio ac lectus vestibulum faucibus eget in metus. In pellentesque faucibus vestibulum. Nulla at nulla justo, eget luctus tortor. Nulla facilisi. Duis aliquet egestas purus in blandit. Curabitur vulputate, ligula lacinia scelerisque tempor,
	lacus lacus ornare ante, ac egestas est urna sit amet arcu. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.&lt;/p&gt;
&lt;p&gt;Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Nullam id dolor id nibh ultricies vehicula ut id elit. Nullam quis risus eget urna mollis ornare vel eu leo. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum
	nibh, ut fermentum massa justo sit amet risus.&lt;/p&gt;
&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ullamcorper nulla non metus auctor fringilla. Donec id elit non mi porta gravida at eget metus.&lt;/p&gt;</code></pre>
</div>
<div class="f-item-controls">
	<span class="f-control" data-f-toggle-control="code" title="Toggle Code">
		<span class="f-icon">
