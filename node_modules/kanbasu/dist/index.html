...
<head>
	...
	<title>カンバス Kanbasu, the CSS Framework</title>
...
<pre>$ npm install --save-dev kanbasu</pre>

<p><strong>As a Git submodule</strong></p>

<pre>$ git submodule add git@github.com:liip/kanbasu.git</pre>

<p>Or simply <a href="https://github.com/liip/kanbasu/archive/master.zip">download the zip</a>.</p>

<h3>Setup</h3>

<p>It’s recommended to copy the framework main file to your project to customize it as you wish. You’ll have to change all <code>@import</code> paths to match the framework location then.</p>

<pre>$ cp node_modules/kanbasu/src/assets/scss/kanbasu.scss destination/kanbasu.scss</pre>

<p>It’s also recommended to duplicated the settings file to have a quick access to all the variables and adapt them to your needs.</p>

<pre>$ cp node_modules/kanbasu/src/assets/scss/settings/_settings.scss destination/settings/_kanbasu.scss</pre>

<p>You should then import it in your main Sass file, <strong>before</strong> other Kanbasu files, to overrides the framework default settings. Learn more about <a href="http://sass-lang.com/documentation/file.SASS_REFERENCE.html#variable_defaults_">Sass default variables</a>.</p>

<h2>Report issues</h2>

<p>Feel free to report any bug or suggestion through Github’s <a href="https://github.com/liip/kanbasu/issues">issues tracker</a>.</p>

<h2>Contribute</h2>

<p>You are welcome to fork and request merge for whatever you think can improve the framework.</p>
<p>Kanbasu is built using Fabricator. As soon as you have Node.js >= 0.10 installed, you just need to run:</p>
<pre>
$ npm install
</pre>
<p>to install all the dependencies and then:</p>
<pre>
$ npm start
</pre>
<p>to start working.</p>
<p>The complete guide is available in <a href="http://fbrctr.github.io/docs/">Fabricator documentation</a>.</p>
<p>Guidelines are simple; keep the code <abbr title="Don’t repeat yourself">DRY</abbr>, follow the <code>.editorconfig</code> and <a href="http://benoitburgener.ch/blog/organize-your-css-declarations/">organize declarations</a>.</p>

<h2>About</h2>

<p>Kanbasu is proudly made at <a href="http://liip.ch">Liip</a>.</p>
